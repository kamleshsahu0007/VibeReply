        ...
        <div class="vr-capsule" id="vr-capsule-body">
          ...
          <div class="vr-capsule-brand" id="vr-capsule-brand" title="Open VibeReply">
            <div class="vr-brand-badge">
              <svg viewBox="0 0 40 40" width="18" height="18" fill="none" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="vr-cap-grad" x1="4" y1="4" x2="36" y2="36" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#00F2FE"/>
                    <stop offset="0.55" stop-color="#38BDF8"/>
                    <stop offset="1" stop-color="#8B5CF6"/>
                  </linearGradient>
                </defs>
                <path d="M 20 4 C 11.16 4 4 11.16 4 20 C 4 23.3 5 26.35 6.72 28.88 L 4.5 35.5 L 11.36 33.45 C 13.9 35.08 16.84 36 20 36 C 28.84 36 36 28.84 36 20 C 36 11.16 28.84 4 20 4 Z"
                      fill="rgba(6, 10, 24, 0.95)" stroke="url(#vr-cap-grad)" stroke-width="2.5" stroke-linejoin="round"/>
                <path d="M 9.5 20.5 H 13.5 L 16 15 L 19.5 26 L 23.5 12 L 26.5 22.5 L 28.5 19 H 30.5"
                      stroke="url(#vr-cap-grad)" stroke-width="2.25" stroke-linecap="round" stroke-linejoin="round"/>
